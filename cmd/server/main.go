...
func run(logger *slog.Logger) error {
	...
	mux.HandleFunc("POST /api/v1/quotes/update", server.HandleUpdateQuote)
	mux.HandleFunc("GET /api/v1/quotes/update/{id}", server.HandleGetUpdate)
	mux.HandleFunc("GET /api/v1/quotes/latest", server.HandleGetLatest)
