...
func TestHandleUpdateQuoteSuccess(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/quote-updates", bytes.NewReader(body))
...
func TestHandleGetUpdateSuccess(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/quote-updates/"+id.String(), nil)
...
func TestHandleGetLatestSuccess(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/quote-updates/latest?pair=eur/mxn", nil)
	w := httptest.NewRecorder()
...
func TestHandleGetLatestUnsupportedPair(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/quote-updates/latest?pair=ABC/XYZ", nil)
	w := httptest.NewRecorder()
...
func TestHandleGetLatestMissingPair(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/quote-updates/latest", nil)
	w := httptest.NewRecorder()
